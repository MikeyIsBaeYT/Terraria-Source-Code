...
namespace Terraria.GameInput
{
  public class LockOnHelper
  {
    ...
    private static bool ValidTarget(NPC n) => n != null && n.active && !n.dontTakeDamage && !n.friendly && !n.townNPC && n.life >= 1 && !n.immortal && (n.aiStyle != 25 || (double) n.ai[0] != 0.0);
    ...
    public static void Draw(SpriteBatch spriteBatch)
    {
      ...
      for (int i = 0; i < LockOnHelper._drawProgress.GetLength(0); ++i)
      {
        ...
        if ((double) num11 > 0.0)
        {
          ...
          {
            float num15 = (float) (6.28318548202515 / (double) num14 * (double) index + (double) Main.GlobalTime * 6.28318548202515 * 0.25);
